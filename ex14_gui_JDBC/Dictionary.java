   ...
   english()
   {
	...
	public void actionPerformed(ActionEvent e) 
    {
	  if(e.getSource()==t[0])
	  {
        ...
        ResultSet rs=smt.executeQuery("SELECT englishword FROM englishwords WHERE smswords='"+x+"'");
		String y;
		while(rs.next())
		{
	  ...
	  if(e.getSource()==t[1])
	  {
		...
		String y;
	    ResultSet rs=smt.executeQuery("SELECT smswords FROM englishwords WHERE englishword='"+x+"'");
	    while(rs.next())
		{
		  t[0].setText(rs.getString("smswords"));
		}
		}
		catch(Exception e1){}
	  }
